...
public:
  ...
  struct fullbit {
    ...
    //Peng
    void get_inode_value(ad_attr_t& inode_attrs, map<string, bufferptr>& inode_xattrs);
...
private:
 ...
 public:
  ...
  // Peng
  void ad_restore_create(MDSRank *mds, journal_entry_t& jentry);
  void ad_restore_attrs(MDSRank *mds, journal_entry_t& jentry);
  void ad_restore_mkdir(MDSRank *mds, journal_entry_t& jentry);
  void ad_restore_unlink_local(MDSRank *mds, journal_entry_t& jentry);
  void ad_restore_rename(MDSRank *mds, journal_entry_t& jentry);
  void ad_restore_link(MDSRank *mds, journal_entry_t& jentry);
  void ad_dump_lump(MDSRank *mds);
  void ad_dump_lump_rename(MDSRank *mds);
  void ad_dump_lump_link(MDSRank *mds);
  void ad_dump_lump_unlink(MDSRank *mds);
};

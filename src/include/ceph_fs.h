...
enum {
	...
	CEPH_MDS_OP_JOURNAL_INIT = 0x01506,
	CEPH_MDS_OP_JOURNAL_ENTRY_HOLD = 0x01507,
	CEPH_MDS_OP_JOURNAL_ENTRY_RELEASE = 0x01508,
	CEPH_MDS_OP_JOURNAL_ENTRYLIST_HOLD = 0x01509,
};
